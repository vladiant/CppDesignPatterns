// https://github.com/PacktPublishing/Software-Architecture-with-Cpp/blob/master/Chapter06/12_state_and_visitation.cpp
...
std::string report_current_state() {
  return std::visit(overload{[](const state::Available &state) -> std::string {
